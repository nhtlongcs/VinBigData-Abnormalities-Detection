...
def create_fasterrcnn_fpn(backbone_name='resnet50', pretrained=False, progress=True, 
    ...
    Arguments:
        ...
        backbone name: backbone_name (string): resnet architecture. Possible values are 'ResNet', 'resnet18', 'resnet34', 'resnet50',
    ...
    model_name=f"fasterrcnn_{backbone_name}_fpn_coco"
    if pretrained and model_name in model_urls.keys():
